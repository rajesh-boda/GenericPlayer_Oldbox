 ...
 *************************************************************/
public class AsyncTaskReGetChannelInfo extends AsyncTask<JSONObject ,String,String> implements DeviceConstants,FolderAndURLConstants {
    private static final String LOGTAG = "AsyncTaskReGetChannelInfo";
    private Context context;//application context
   // private ProgressDialog progressDialog = null;//to display loading status
    private String deviceId;
    public AsyncTaskReGetChannelInfo(Context context) {
    ...
    protected String doInBackground(JSONObject... params) {
        ...
        try {
            ...
            //Log.v(LOGTAG, "params " + params[0]);
            //posting data to php service

//            String data = URLEncoder.encode(DEVICE_ID, "UTF-8")
//                    + "=" + URLEncoder.encode("aaa", "UTF-8");////aaa
//                        data += "&" + URLEncoder.encode(LICENSE_KEY, "UTF-8") + "="
//                    + URLEncoder.encode("9cc9809154", "UTF-8");////9cc9809154
            String data = URLEncoder.encode("device_id", "UTF-8")
            ...
            if (code == 200) {
                ...
                if (responseCode.equals(RESPONSE_CODE_200)) {
                   // Log.w(LOGTAG,"license data received");
                    ...
                    UpdateChannelInfo updateChannelInfo = new UpdateChannelInfo(context);
                    //inserting channel info to table
                    updateChannelInfo.updateChannelInfo(serviceReponse);
                   // Log.w(LOGTAG, "license data inserted");
            ...
            SendExceptionsToServer sendExceptionsToServer = new SendExceptionsToServer(context);
            sendExceptionsToServer.sendMail(AsyncTaskReGetChannelInfo.this.getClass().getName(), Utils.convertExceptionToString(e), "Exception");
        }
